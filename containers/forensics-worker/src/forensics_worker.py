...
class ForensicsWorker:
    ...
    def analyze_instance(self, instance_id, snapshot_ids=None, operation_id=None):
        ...
        try:
            ...
            report = self._generate_forensic_report(
                instance_id, metadata, snapshot_analysis, threat_intel, operation_id
            )
    ...
    def _collect_instance_metadata(self, instance_id, operation_id):
        ...
        try:
            ...
            try:
                attributes = ec2_client.describe_instance_attribute(InstanceId=instance_id, Attribute="userData")
    ...
    def _analyze_snapshot(self, snapshot_id, operation_id):
        ...
        try:
            ...
            self._log_step(
                operation_id, "analyze_snapshot", "success", f"Analyzed snapshot {snapshot_id} (risk: {risk_score})"
            )
            return analysis
    ...
    def _simulate_filesystem_analysis(self, snapshot_path):
        if not snapshot_path or not os.path.isdir(snapshot_path):
            return {
                ...
                "file_types_found": {"executables": 0, "scripts": 0, "configuration": 0, "logs": 0, "temp_files": 0},
            ...
            recommendations.append(
                {
                    ...
                    "description": (
                        "Immediate termination of all compromised resources recommended due to critical findings"
                    ),
                }
            )
