...
class SIEMForwarder:
    ...
    def _get_siem_config(self):
        ...
        try:
            endpoint_response = self.ssm_client.get_parameter(Name="/soar/siem/endpoint", WithDecryption=True)
            api_key_response = self.ssm_client.get_parameter(Name="/soar/siem/api_key", WithDecryption=True)
