...
class JiraManager:
    ...
    def _get_jira_config(self):
        ...
        try:
            url_response = self.ssm_client.get_parameter(Name="/soar/jira/url", WithDecryption=True)
            username_response = self.ssm_client.get_parameter(Name="/soar/jira/username", WithDecryption=True)
            token_response = self.ssm_client.get_parameter(Name="/soar/jira/api_token", WithDecryption=True)
