    ...
    try:
        ...
        snapshot_result = {
            ...
            "instance_details": {
                ...
                "launch_time": instance_details.get("LaunchTime").isoformat()
                if instance_details.get("LaunchTime")
                else None,
            },
        ...
        event["workflow_metadata"]["timestamp"] = datetime.now(UTC).isoformat()
            ...
            TagSpecifications=[
                {
                    ...
                    "Tags": [
                        ...
                        {"Key": "CreatedBy", "Value": "SOAR-Workflow"},
                    ],
                }
            ],
        )
